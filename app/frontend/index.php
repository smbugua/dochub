...
<html lang="en">
   <head>
      ...
      <title><?php echo $exec->set_title('DocHub');?>- Documentaries Poll</title>
      <!-- Favicon Icon -->
                     ...
                     <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="video-card">
                           <div class="video-card-image">
                              ...
                              <iframe width="400" height="315" src="https://www.youtube.com/embed/videoseries?list=PLx0sYbCqOb8TBPRdmBHs5Iftvv9TPboYG" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                           </div>
               ...
               <div class="container">
                  <div class="row no-gutters">
                     <div class="col-lg-6 col-sm-6">
                        <p class="mt-1 mb-0">&copy; Copyright <?php echo date('Y')?> <strong class="text-dark"><?php echo $exec->set_title('DocHub');?></strong>. All Rights Reserved<br>
                           <small class="mt-0 mb-0">Made with <i class="fas fa-heart text-danger"></i> by <a class="text-primary" target="_blank" href="https://github.com/smbugua">Ask Mbugua</a>
                           </small>
                        </p>
                     </div>
